...
@Story_GPBM-3547 @Sprint16_iOS
@Story_GPBM-3597 @Sprint16_aOS

Feature: Holdings by Asset Class and Sub-Asset Class at Account level

  As a client I want to see the individual holdings that make up my exposure to each Asset Class AND sub-asset class within an account
  ...
  @SIT
  Scenario: holding by account asset class
    Given I login as type "account_class_holdings_have_positive"
    Then I should on the allocation holding list

  @S3547-AC1-AT1
  @DependsOn('holding_by_account_asset_class')
  Scenario: Check the holding UI by Account allocation asset class
...
#      | Pips indicating the number of different asset classes invested in (informs user that they can swipe across asset classes) |               |
  ...
  @SIT
  @DependsOn('holding_by_account_asset_class')
  Scenario: Check whether the Account allocation asset class holdings are ordered from largest to smallest based on market value in Account reference currency
    Given I am on the allocation holding list
  ...
  @SIT
  @DependsOn('holding_by_account_asset_class')
  Scenario: Check format of Account base currency and Account Total assets value for the Asset Class in Account allocation Asset Class holding wrapper
    Given I am on the allocation holding list
  ...
  @S3547-AC1-AT4 @NotInMock
  @SIT
  @DependsOn('holding_by_account_asset_class')
  Scenario: Check whether the Account asset classes amount equals the sum of all holdings list value when the Group by sub-asset class toggle is OFF
    Given I am on the allocation holding list
    Then I should see the asset class amount equals the sum of all holdings list value

  @S3547-AC1-AT6
  Scenario: Check the graphic view in Account Allocation Asset Class holding wrapper When the asset class value is positive
    Given I login as type "account_class_holdings_weight_is_positive"
    Then the asset class weight is positive in the pie-char
#   can not check color
#    Then I should see a graphic pie-char in Account allocation class holding wrapper,and there are one color in the pie-char,and there is an asset class weight in the pie-char
#    And the color in graphic is same to the color that I see in the Account allocation Asset Class graphic pie-char within the current asset class
#    And the position in graphic is same to the position that I see in the Account allocation Asset Class graphic pie-char within the current asset class


  @S3547-AC1-AT7
  Scenario: Check the graphic view in Account Allocation Asset Class holding wrapper When the asset class value is negative
    Given I login as type "account_class_holdings_weight_is_negative"
#    Then I should see a graphic pie-char in Account Allocation Asset Class holding wrapper
#    And there are no any color in the pie-char
  ...
  @S3547-AC1-AT8
  Scenario: Check the graphic view in Account Allocation Asset Class holding wrapper Wen the asset class value is 0.00
    Given I login as type "account_class_holdings_weight_is_zero"
#    Then I should see a graphic pie-char in Account Allocation Asset Class holding wrapper
...
#  @S3547-AC1-AT9
#  Scenario: Check the 2dp format of asset class weight in Account allocation class holding wrapper
#    Then I should the 2dp format of asset class weight


  @S3547-AC1-AT10
  Scenario: Check whether Account asset class name/Asset Class amount/graphic pie-char for the asset class will be changed when I slide the pips left or right on asset class holdings wrapper
    Given I login as type "account_class_holdings_wrapper_swipe_left_changed"
...
#  Scenario 2: Access holdings per Asset Class via Allocation List
  @S3547-AC2-AT1
  Scenario: Check whether I can view holding list when I tap on the tile of a particular Asset Class in Account level
...
#  Scenario 3: Holdings grouped per Sub-Asset Class
  @SIT
  Scenario: holding by account asset subclass
  ...
  @S3547-AC3-AT1
  @SIT
  @DependsOn('holding_by_account_asset_subclass')
  Scenario: Check whether the Account sub asset class are ordered from largest to smallest based on sub asset class amount,then by sub asset class name alphabetical a-z
    Given I am on the allocation holding list
...
#    And the holdings are ordered within each sub-asset class from largest to smallest based on market value in Account reference currency

  @S3547-AC3-AT3
  @SIT
  @DependsOn('holding_by_account_asset_subclass')
  Scenario: Check whether the Account sub asset classes amount equals the sum of its  all holdings list value when the Group by sub-asset class toggle is ON
    Given I am on the allocation holding list
    Then I should see the sub asset classes amount equals the sum of its all holdings list value

  @S3547-AC3-AT4 @NotInMock
  @SIT
  @DependsOn('holding_by_account_asset_subclass')
  Scenario: Check whether the Account asset classes amount in the holding wrapper equals the sum of sub-asset class amount when I tap the Group by sub-asset class toggle ON
    Given I am on the allocation holding list
  ...
  @SIT
  @DependsOn('holding_by_account_asset_subclass')
  Scenario: Check format of Account base currency and Account Sub-asset Class amount for the Asset Class in Account allocation Asset Class holding wrapper
    Given I am on the allocation holding list
    Then I should see the allocation holdings wrapper base currency are displayed in ISO 3 code and 2 d.p. format
  ...
  Scenario: Check whether holding list will be changed and the sub-asset class toggle is OFF when I slide the pips left or right on asset class holdings wrapper
    Given I login as type "account_class_holdings_swipe_left_changed"
...
#    And the sub-asset class toggle is OFF within current asset class
  ...
  Scenario: Check whether holding list will be changed and the sub-asset class toggle is ON when I slide the pips left or right on asset class holdings wrapper
    Given I login as type "account_holdings_subClass_swipe_left_changed"
    When I tap on holdings grouped per Sub Asset class
