...
@Story_GPBM-2335 @Sprint8_iOS
@Story_GPBM-2334 @Sprint8_aOS

Feature: Portfolio Total Liabilities Overlay(Singapore)

  As a Client I want to see a detailed view regarding my Direct Investments (Private Equity),
  Promemoria and Other yes holdings, so that I can see all related information about the particular holding.

  @SIT
  Scenario: Portfolio Total Liabilities Overlay Singapore
  ...
  @S441-AC1-AT1
  @DependsOn('Portfolio_Total_Liabilities_Overlay_Singapore')
  Scenario:Check the UI of Portfolio Total Liabilities Overlay Singapore
  ...
  @SIT
  @DependsOn('Portfolio_Total_Liabilities_Overlay_Singapore')
  Scenario:Check the Portfolio base curreny ISO 3 code in Portfolio Total Liabilities Overlay(Singapore)
    Given I am on the global overlay screen
...
#  update in sprint 10
#  @S441-AC1-AT5
#  @DependsOn('Check_the_UI_of_Portfolio_Total_Liabilities_Overlay_Singapore')
...
#    Then I should see the the total liabilities overlay is closed
  ...
  @S441-AC1-AT3
  Scenario:Check whether Portfolio Total Liabilities overlay(Singapore) will be cahnged when I swap the pips
